    ...
    <table class="table table-hover text-center">
      ...
      <tbody>
        ...
        include 'php/connection.php';
            $sql = "SELECT user.mem_id, user.userName,  appointment.dateNow, appointment.appointDate, appointment.appointTime, transaction.payment_status FROM user, appointment, transaction WHERE user.mem_id=appointment.mem_id AND appointment.mem_id = transaction.mem_id ORDER BY appointment.appointDate ASC";
