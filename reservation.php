...
<body>
  ...
  <div class="container">
     <div class="text-center mb-4">
        <h2>Reserve date and time for consultation</h2>
        <?php
    if(isset($_GET['msg'])){
        $msg = $_GET['msg'];
    ...
    <div class="container d-flex justify-content-center">
        <form action="book.php" method="post" style="width:58vw; min-width:300px;">
            <div class="row">
                <div class="col">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="date_appoint" value="">
                </div>
                <div class="mb-3">
                    <label class="form-label">Time of Appointment: </label>
                    <input type="time" class="form-control" name="time_appoint" value="">
                </div>
