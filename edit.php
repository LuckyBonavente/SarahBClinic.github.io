<?php
 ...
 if(isset($_POST["submit"])){
    ...
    $sql = "UPDATE `user` SET `firstName`='$first_name',`lastName`='$last_name',`emailAd`='$email', `userName` = '$user', `phone`='$phone',`address`='$address',`birthDate`='$bday',`bloodGrp`='$bloodgrp',`bloodPress`='$bloodpres',`temp`='$temp',`pulseRt`='$pulse',`weight`='$weight',`height`='$height' WHERE mem_id=$id";
...
<body>
    ...
    <?php
    $sql = "SELECT * FROM `user` WHERE mem_id = $id LIMIT 1";
    $result = mysqli_query($con, $sql);
        ...
        <form action="" method="post" style="width:58vw; min-width:300px;">
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="email" value="<?php echo $row['emailAd'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="bloodGrp" value="<?php echo $row['bloodGrp'] ?>">
                </div>
                <div class="col">
                    <label class="form-label">Blood Pressure: </label>
                    <input type="text" class="form-control" name="bloodPress" value="<?php echo $row['bloodPress'] ?>">
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="pulseRt" value="<?php echo $row['pulseRt'] ?>">
                </div>
                <div class="col">
